import 'package:farmersmarketplace/screens/farmerDashboard/edit_promotion_products.dart';
...
class FarmerSpecials extends StatefulWidget {
  const FarmerSpecials({super.key});

  @override
  State<FarmerSpecials> createState() => _FarmerSpecialsState();
}

class _FarmerSpecialsState extends State<FarmerSpecials> {
  ...
  Future<void> deleteBooking(String bookingId) async {
    try {
      await _firestore.collection('specials').doc(bookingId).delete();
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Promotional Deals"),
          centerTitle: true,
        ),
        body: Stack(
          children: [
                        ...
                        child: ListTile(
                          subtitle: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Start on: ${bookingData['startDate']}',
                                style: const TextStyle(fontSize: 15),
                              ),
                              Text(
                                'End on: ${bookingData['endDate']}',
                                style: const TextStyle(fontSize: 15),
                              ),
                              Text(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            Navigator.pushNamed(context, '/addSpecial');
          },
