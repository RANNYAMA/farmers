...
class AddSpecialScreen extends StatefulWidget {
  const AddSpecialScreen({super.key});

  @override
  State<AddSpecialScreen> createState() => _AddSpecialScreenState();
}

class _AddSpecialScreenState extends State<AddSpecialScreen> {
  ...
  Future<void> _register() async {
    ...
    if (priceErrorText == null &&
      ...
      try {
        ...
        await FirebaseFirestore.instance.collection('specials').add(userData);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Promotional Products"),
        centerTitle: true,
      ),
            ...
            children: [
              ...
              TextField(
                ...
                onChanged: (value) {
                  if (value.isEmpty) {
                    setState(() {
                      descriptionErrorText = 'Special Description is required';
                    });
                  } else {
                    setState(() {
                      descriptionErrorText = null;
